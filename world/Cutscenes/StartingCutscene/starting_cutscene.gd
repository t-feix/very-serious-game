...
const PANELS = [
	["res://world/Cutscenes/StartingCutscene/S01.png", "You are Ronald H. Spreadsheet, CEO of the very serious and succesful CorpA. But the evil thugs of CorpB have stolen your cat Bartholomeow!", 4.0],
	["res://world/Cutscenes/StartingCutscene/S02.png", "Quickly you grab the fob watch that can rewind your own time stream.", 4.0],
	["res://world/Cutscenes/StartingCutscene/S03.png", "It's time to save Bartholomeow.", 4.0],
]
